      ...
      {loadingComplete && (
        <div className="max-w-7xl mx-auto px-6 sm:px-8 relative z-10 text-center w-full">
          ...
          >
            ...
            <span className="text-white/90 text-xs font-barlow-condensed font-bold tracking-widest uppercase custom-barlow-menu">Serving Northeast TX & Southeast OK</span>
          </motion.div>
          ...
          <motion.h1
            ...
            initial="hidden"
            animate="visible"
            className="text-4xl min-[400px]:text-5xl sm:text-6xl lg:text-7xl font-barlow font-black uppercase tracking-tight text-white leading-[1.1] mb-6 px-1 custom-barlow-title"
          >
          ...
          <motion.p
            ...
            className="mt-6 text-base min-[400px]:text-lg sm:text-2xl text-slate-300 leading-relaxed max-w-3xl mx-auto font-inter font-light px-2 sm:px-4 custom-inter-body"
          >
          ...
          >
            <Link
              to="/contact"
              className="group relative inline-flex items-center justify-center px-8 py-4 text-sm font-barlow-condensed font-bold uppercase tracking-widest text-white bg-primary rounded-md transition-all shadow-[0_0_20px_rgba(44,69,174,0.5)] hover:shadow-[0_0_35px_rgba(44,69,174,0.8)] hover:-translate-y-1 overflow-hidden custom-barlow-menu"
            >
            ...
            <a
              href="#services"
              className="inline-flex items-center justify-center px-8 py-4 text-sm font-barlow-condensed font-bold uppercase tracking-widest text-white bg-transparent border-2 border-white/30 rounded-md hover:bg-white/10 hover:border-white transition-all backdrop-blur-sm custom-barlow-menu"
            >
