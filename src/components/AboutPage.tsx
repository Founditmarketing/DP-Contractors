      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-20 lg:mb-32">
          <motion.div 
            ...
            className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-white/5 border border-white/10 text-slate-300 text-xs font-barlow-condensed font-bold tracking-widest uppercase mb-8 backdrop-blur-md custom-barlow-menu"
          >
          ...
          <motion.h1 
            ...
            className="text-5xl md:text-6xl lg:text-7xl font-barlow font-black uppercase tracking-tight text-white leading-[1.1] mb-8 custom-barlow-title"
          >
          ...
          <motion.p 
            ...
            className="text-xl md:text-2xl text-slate-300 font-inter font-light leading-relaxed custom-inter-body"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center mb-32">
          ...
          >
            ...
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 lg:left-6 lg:-translate-x-0 w-[85%] sm:w-auto text-center lg:text-left z-20 bg-slate-900/90 backdrop-blur-md p-6 rounded-xl border border-slate-700/50">
              <p className="text-3xl font-barlow font-black text-white custom-barlow-title">35+</p>
              <p className="text-primary font-barlow-condensed font-semibold uppercase tracking-widest text-xs custom-barlow-menu">Years of Mastery</p>
            </div>
          </motion.div>
          ...
          >
            <div className="space-y-8 text-lg text-slate-400 font-inter font-light leading-relaxed custom-inter-body">
            ...
            <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-4">
               {[
                 ...
                 <div key={i} className="flex items-center justify-center lg:justify-start text-sm font-barlow-condensed font-bold uppercase tracking-widest text-slate-300 custom-barlow-menu">
        ...
        <div className="border-t border-white/5 pt-24 mb-32">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-barlow font-black uppercase tracking-tight text-white mb-4 custom-barlow-title">Why Choose D&P</h2>
            <p className="text-slate-400 font-inter font-light max-w-2xl mx-auto custom-inter-body">We understand the massive requirements of commercial-scale facilities. Our squad is built entirely on a foundation of technical superiority.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            {trustFactors.map((factor, idx) => (
              ...
              >
                ...
                <h3 className="text-xl font-barlow font-bold uppercase tracking-widest text-white mb-4 custom-barlow-title">{factor.title}</h3>
                <p className="text-slate-400 font-inter font-light leading-relaxed custom-inter-body">{factor.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        >
          ...
          <div className="relative z-10 p-12 lg:p-16 flex flex-col lg:flex-row items-center justify-between gap-10">
            <div className="text-center lg:text-left">
              <h2 className="text-3xl lg:text-4xl font-barlow font-black uppercase tracking-tight text-white mb-4 custom-barlow-title">
                The Last HVAC Company You Will Call.
              </h2>
              <p className="text-lg text-slate-300 font-inter font-light max-w-xl custom-inter-body">
            ...
            <div className="flex flex-col sm:flex-row gap-4 shrink-0">
              <a
                href="tel:9037851972"
                className="inline-flex items-center justify-center px-8 py-4 text-xs md:text-sm font-barlow-condensed font-bold uppercase tracking-widest text-white bg-accent rounded-xl shadow-[0_0_20px_rgba(232,2,2,0.4)] hover:shadow-[0_0_35px_rgba(232,2,2,0.6)] hover:-translate-y-1 transition-all custom-barlow-menu"
              >
                Call (903) 785-1972
              </a>
              <Link
                to="/contact"
                className="inline-flex items-center justify-center px-8 py-4 text-xs md:text-sm font-barlow-condensed font-bold uppercase tracking-widest text-white bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl transition-all hover:-translate-y-1 group custom-barlow-menu"
              >
                Partner With Us
