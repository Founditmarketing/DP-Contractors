      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          ...
          >
            ...
            <span className="text-white font-barlow-condensed font-bold tracking-widest uppercase text-xs custom-barlow-menu">Command Center</span>
          </motion.div>
          ...
          <motion.h2 
            ...
            className="text-3xl leading-[1.1] sm:text-5xl lg:text-6xl font-barlow font-black uppercase tracking-tight text-white tracking-wider mb-6 drop-shadow-lg px-2 custom-barlow-title"
          >
          ...
          <motion.p
            ...
            className="text-xl sm:text-2xl text-blue-100 font-barlow-condensed font-semibold tracking-widest uppercase text-sm custom-barlow-menu"
          >
              ...
              >
                {result !== 'not-found' ? (
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                      <div>
                        <div className="flex items-center justify-center sm:justify-start mb-3">
                          ...
                          <span className="text-green-600 font-barlow-condensed font-bold uppercase tracking-widest text-xs custom-barlow-menu">Priority Zone</span>
                        </div>
                        <h3 className="text-2xl sm:text-3xl font-barlow font-black uppercase tracking-tight text-slate-900 mb-2 flex items-center justify-center sm:justify-start tracking-wider custom-barlow-title">
                          <MapPin className="w-7 h-7 text-primary mr-2" />
                          {result.city}, {result.state}
                        </h3>
                        <p className="text-xl text-slate-600 font-inter font-light flex items-center justify-center sm:justify-start custom-inter-body">
                      ...
                      <div className="flex-shrink-0 w-full sm:w-auto">
                        <a
                          href="tel:9037851972"
                          className="flex flex-col items-center justify-center w-full px-8 py-4 bg-accent text-white font-barlow-condensed font-bold uppercase tracking-widest text-sm rounded-xl shadow-[0_0_20px_rgba(232,2,2,0.4)] hover:shadow-[0_0_30px_rgba(232,2,2,0.6)] hover:-translate-y-1 transition-all animate-vibrate custom-barlow-menu"
                        >
                          <span className="flex items-center">
                            <PhoneCall className="w-5 h-5 mr-2" />
                            Dispatch Tech Now
                          </span>
                          <span className="text-xs font-barlow-condensed font-semibold mt-1 opacity-90 tracking-widest custom-barlow-menu">(903) 785-1972</span>
                        </a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-6 sm:p-8 text-center bg-slate-50">
                    ...
                    <h3 className="text-2xl font-barlow font-extrabold uppercase tracking-tight text-slate-900 mb-3 tracking-wider custom-barlow-title">
                      Location Outside Standard Zones
                    </h3>
                    <p className="text-lg text-slate-600 font-inter font-light mb-6 max-w-lg mx-auto leading-relaxed custom-inter-body">
                      We serve Northeast TX and Southeast OK. Call us immediately to verify dispatch to your exact location.
                    </p>
                    <a
                      href="tel:9037851972"
                      className="inline-flex items-center justify-center px-8 py-4 bg-slate-900 text-white font-barlow-condensed font-bold uppercase tracking-widest text-xs rounded-xl shadow-lg hover:bg-slate-800 transition-all custom-barlow-menu"
                    >
                      <PhoneCall className="w-5 h-5 mr-2" />
        ...
        >
          <p className="text-center text-blue-200 font-barlow-condensed font-semibold mb-6 uppercase tracking-widest text-xs custom-barlow-menu">Quick Select City</p>
            ...
            {serviceZones.map((zone) => (
              ...
              >
                ...
                <div className="relative z-10">
                  <h3 className="text-sm font-barlow-condensed font-bold uppercase tracking-widest text-white group-hover:text-accent transition-colors duration-300 custom-barlow-menu">
                    {zone.city}
                  </h3>
                  <p className="text-xs text-slate-400 font-inter font-light mt-1 custom-inter-body">{zone.state}</p>
                </div>
