  ...
  return (
    ...
    >
      ...
      <div className={`text-center relative z-10 transition-all duration-700 w-full max-w-sm px-6 ${
        ...
        <h2 className="text-xs md:text-sm font-inter font-light text-white/80 tracking-[0.4em] uppercase mb-5 custom-inter-body">
        ...
        <div className="flex items-center justify-center space-x-3">
          ...
          <p className="text-white/40 font-inter text-[10px] md:text-[11px] tracking-[0.2em] uppercase custom-inter-body">
