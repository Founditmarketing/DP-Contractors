      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-4">
            ...
            />
            <p className="text-slate-400 font-inter font-light leading-relaxed mb-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center p-3 bg-slate-900/80 border border-slate-800 rounded-lg">
                ...
                <span className="text-white font-inter font-light">Licensed, Bonded & Insured</span>
              </div>
              <div className="flex items-center p-3 bg-slate-900/80 border border-slate-800 rounded-lg">
                <Clock className="w-6 h-6 text-accent mr-3" />
                <span className="text-white font-inter font-light">24/7 Emergency Dispatch</span>
              </div>
              <div className="flex items-center p-3 bg-slate-900/80 border border-slate-800 rounded-lg">
                <MapPin className="w-6 h-6 text-primary mr-3" />
                <span className="text-white font-inter font-light">1150 Clement Rd. Paris, TX 75460</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-3">
            <h4 className="text-sm font-barlow-condensed font-bold text-white mb-6 uppercase tracking-widest">Service Areas</h4>
          ...
          <div className="lg:col-span-5">
            <div className="bg-slate-900/80 backdrop-blur-md p-8 rounded-2xl border border-slate-800 shadow-2xl">
              <h4 className="text-xl font-barlow font-extrabold uppercase tracking-tight text-white mb-6">Request Service</h4>
        ...
        <div className="pt-8 border-t border-slate-800 text-center flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0 space-x-6 text-sm text-slate-500 font-inter font-light">
