      ...
      {isOpen && (
        ...
        >
          <div className="px-4 pt-2 pb-6 space-y-2">
            <Link to="/" onClick={() => setIsOpen(false)} className="block px-3 py-3 text-sm font-barlow-condensed font-semibold uppercase tracking-widest text-white hover:bg-slate-800 rounded-md">Home</Link>
            ...
            <div className="px-3 py-2">
              ...
              <div className="pl-3 space-y-2 border-l-2 border-primary/30 ml-2">
                ...
                <Link to="/services/restaurant-ventilation" onClick={() => setIsOpen(false)} className="block text-xs font-barlow-condensed uppercase tracking-widest text-slate-300 hover:text-white">Restaurant Ventilation</Link>
                <Link to="/services/heavy-duty-hvac" onClick={() => setIsOpen(false)} className="block text-xs font-barlow-condensed uppercase tracking-widest text-slate-300 hover:text-white">Heavy-Duty HVAC</Link>
              </div>
            </div>
            <div className="px-3 py-2">
